...
class CasesPage extends StatelessWidget {
  final appointmentNavController = Get.put(AppointmentNavController());
          ...
          child: Column(
            ...
            children: [
              ...
              Obx(() => SingleChildScrollView(
                    ...
                    child: Row(
                      children: appointmentNavController.appointmentTabs.map((tab) {
                        final isSelected =
                            appointmentNavController.selectedTab.value == tab.label;

                        return GestureDetector(
                          onTap: () => appointmentNavController.changeTab(tab.label),
                          child: Container(
                            ...
                            child: Center(
                              child: Text(
                                tab.label,
                                style: (tab.style ?? AppFonts.subtext).copyWith(
                  ...
                  SizedBox(height: 14),
                  Obx(() => appointmentNavController.getSelectedAppointmentScreen()),
            ],
          ),
        ),
      ),
