      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Text("Specialist Second Opinion Report", style: AppFonts.subheading),
               SizedBox(height: 10),
              Text('Provide a clear, detailed clinical assessment. This will be the patient-facing final document.', style: AppFonts.textSecondary),
               SizedBox(height: 10),
              Text("Case ID: GHO-2024-9481", style: AppFonts.subheading16.copyWith(fontSize: 14,)),
               SizedBox(height: 10),
               Row(
                mainAxisAlignment: MainAxisAlignment.start,
                children: [
                  Text("Allotted Time: 6 hrs", style: AppFonts.textSecondary.copyWith(fontSize: 16, color: AppColors.red),),
                   SizedBox(width: 4),
                  Icon(Icons.circle, size: 6, color: AppColors.red),
                   SizedBox(width: 4),
                  Text("Due Date: Oct 14, 2025", style: AppFonts.textSecondary.copyWith(fontSize: 16, color: AppColors.red),),
                ],
              ),
              SizedBox(height: 20),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: CustomButton(
                            text: "Review & Confirm Submission", onPressed: () {}),
                      ),
                    ],
                  ),
                ),
